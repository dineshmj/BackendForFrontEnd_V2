...
{
	public static class ProductsMicroservice
	{
		public const string CLIENT_NAME_FOR_IDP = "Products Microservice BFF Client";
		public const string CLIENT_ID_FOR_IDP = "Products.Microservice.BFF.ClientID";
