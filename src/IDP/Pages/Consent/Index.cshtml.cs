...
namespace FW.IDP.Pages.Consent;
...
public sealed class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (request == null) return RedirectToPage("/Home/Error/Index", ct);
        ...
        {
            return RedirectToPage("/Home/Error/Index", ct);
        }
    ...
    private ViewModel CreateConsentViewModel(AuthorizationRequest request)
    {
        ...
        var apiResources = request.ValidatedResources.Resources.ApiResources.Where(apiRes => resourceIndicators.Contains(apiRes.Name));
