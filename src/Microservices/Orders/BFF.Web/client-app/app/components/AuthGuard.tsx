...
//
// FIXME: This component currently duplicates logic found in useAuth.ts
// FIXME: Consider refactoring to avoid redundancy.
//
    ...
    if (showLoginMessage) {
      ...
      return (
        <div style={{ padding: '2rem', fontFamily: 'system-ui', textAlign: 'center' }}>
          ...
          <p>
            !! From AuthGuard !! - User is not authenticated. Please login from
